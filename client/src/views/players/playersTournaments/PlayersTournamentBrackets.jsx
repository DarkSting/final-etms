...
import "./PlayersTournamentBrackets.css";

export default function PlayersTournamentBrackets() {
...
export const SingleElimination = ({ search }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `/api/organizers/${esportsTitle}/tournament/${tournamentId}/get-tournament?tournamentName=${"CSGO LK League Season One"}`
      )
      .then((r) => {
        setMatches(r.data);
      })
