...
function Dota2Team() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      // Send a POST request to the server's '/api/players/create-team/dota-2' endpoint
      const response = await axios.post("/api/players/create-team/dota-2", {
        esportsTitle,
        teamName,
        teamTag,
        teamDescription,
      ...
      navigate(`/players/dota-2/team/${teamId}`);
    } catch (error) {
