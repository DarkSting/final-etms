...
function ValorantTeam() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      // Send a POST request to the server's '/api/players/create-team/valorant' endpoint
      const response = await axios.post("/api/players/create-team/valorant", {
        esportsTitle,
        teamName,
        teamTag,
        teamDescription,
      ...
      navigate(`/players/valorant/team/${teamId}`);
    } catch (error) {
  ...
  return (
    <div className="create-team-wrapper">
      ...
      <Container>
        {/* Heading */}
        <h1 className="create-team-heading">Create Valorant Team</h1>
