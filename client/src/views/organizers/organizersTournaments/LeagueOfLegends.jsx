...
function LeagueOfLegends() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const esportsTitle = "lol";

      // Send a POST request to the server's '/api/organizers/create-tournament/lol' endpoint
      const response = await axios.post(
        "/api/organizers/create-tournament/lol",
        {
          esportsTitle,
          tournamentName,
      ...
      navigate(`/organizers/lol/tournament/${tournamentId}`);
    } catch (error) {
    ...
    <div className="create-tournament-wrapper">
      ...
      <Container>
        ...
        <h1 className="create-tournament-heading">
          Create League of Legends Tournament
        </h1>
        ...
        <Form className="create-tournament-form" onSubmit={handleFormSubmit}>
          ...
          <Form.Group controlId="isOnline" className="mt-3 mb-3">
            <Form.Check
              ...
              checked={isOnline}
              id="lol-is-tournament-held-offline"
