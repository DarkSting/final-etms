...
// Helper function to validate eSports titles
function isValidEsportsTitle(title) {
  // Define an array of valid eSports titles
  const validEsportsTitles = ["cs-go", "dota-2", "valorant", "lol"];
  return validEsportsTitles.includes(title);
}
